...
/**
 * <pre>
 * 버젼 별 weblogic.xml에 대한 파싱 기능을 테스트 하기 위한 테스트 클래스
 * </pre>
 * 
 * @author Sang-cheon Park
 * @version 1.0
 */
public class WeblogicXMLParserTest {
	...
	public void testWithNullParam() {
		...
		try {
			// 테스트
			new WeblogicXMLParser().parse(file, analyzeDefinition);
		...
		// 초기화
		file = new File(this.getClass().getResource("/parser/weblogic.xml").getFile());
	...
	/**
	 * <pre>
	 * weblogic.xml 파일에 대한 파싱 테스트
	 * </pre>
	 */
	@Test
	public void testWeblogic() {
		// 초기화
		File file = new File(this.getClass().getResource("/parser/weblogic.xml").getFile());
...
//end of WeblogicXMLParserTest.java