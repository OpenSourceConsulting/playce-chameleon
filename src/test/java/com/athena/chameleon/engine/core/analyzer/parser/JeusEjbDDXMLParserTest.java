...
/**
 * <pre>
 * 버젼 별 jeus-ejb-dd.xml에 대한 파싱 기능을 테스트 하기 위한 테스트 클래스
 * </pre>
 * 
 * @author Sang-cheon Park
 * @version 1.0
 */
public class JeusEjbDDXMLParserTest {
	...
	public void testWithNullParam() {
		...
		try {
			// 테스트
			new JeusEjbDDXMLParser().parse(file, analyzeDefinition);
		...
		// 초기화
		file = new File(this.getClass().getResource("/parser/jeus-ejb-dd.xml").getFile());
	...
	/**
	 * <pre>
	 * jeus-ejb-dd.xml 파일에 대한 파싱 테스트
	 * </pre>
	 */
	@Test
	public void testJeusEjbDD() {
		// 초기화
		File file = new File(this.getClass().getResource("/parser/jeus-ejb-dd.xml").getFile());
	...
	}//end of testJeusEjbDD()

}
//end of JeusEjbDDXMLParserTest.java