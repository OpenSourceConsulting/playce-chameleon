...
/**
 * <pre>
 * 버젼 별 weblogic-ejb-jar.xml에 대한 파싱 기능을 테스트 하기 위한 테스트 클래스
 * </pre>
 * 
 * @author Sang-cheon Park
 * @version 1.0
 */
public class WeblogicEjbJarXMLParserTest {
	...
	public void testWithNullParam() {
		...
		try {
			// 테스트
			new WeblogicEjbJarXMLParser().parse(file, analyzeDefinition);
		...
		// 초기화
		file = new File(this.getClass().getResource("/parser/weblogic-ejb-jar_8_1.xml").getFile());
	...
	/**
	 * <pre>
	 * 8.1버젼의 weblogic-ejb-jar.xml 파일에 대한 파싱 테스트
	 * </pre>
	 */
	@Test
	public void testWeblogicEjbJar_8_1() {
		// 초기화
		File file = new File(this.getClass().getResource("/parser/weblogic-ejb-jar_8_1.xml").getFile());
	...
	}//end of testWeblogicEjbJar_8_1()
	
	/**
	 * <pre>
	 * 9.0버젼의 weblogic-ejb-jar.xml 파일에 대한 파싱 테스트
	 * </pre>
	 */
	@Test
	public void testWeblogicEjbJar_9_0() {
		// 초기화
		File file = new File(this.getClass().getResource("/parser/weblogic-ejb-jar_9_0.xml").getFile());
		AnalyzeDefinition analyzeDefinition = new AnalyzeDefinition();
	...
	}//end of testWeblogicEjbJar_9_0()
	
}
//end of WeblogicEjbJarXMLParserTest.java