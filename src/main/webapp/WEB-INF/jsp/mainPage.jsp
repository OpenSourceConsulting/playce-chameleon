...
<table border="0">
    ...
    <div id="navigation">
			<ul>
            	<li id="active"><a href="/chameleon/main.do">Home</a></li>
                <li><a href="/chameleon/upload/form.do">Migration</a></li>
...
<table border="0">
	<tr>
		<td width="50">&nbsp;</td>
		<td width="150"><img src="/chameleon/images/extract-icon.png"></td>
	...
	<tr>
		<td width="50">&nbsp;</td>
		<td width="150"><img src="/chameleon/images/pdf-icon.png"></td>
	...
	<tr>
		<td width="50">&nbsp;</td>
		<td width="150"><img src="/chameleon/images/linux-icon.png"></td>
