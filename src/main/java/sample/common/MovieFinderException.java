...
public class MovieFinderException extends BaseException {
    ...
    private static final long serialVersionUID = 795393305090011321L;
     ...
     */
    public MovieFinderException(final MessageSource messageSource, final String messageKey, final Object[] messageParameters, final Throwable wrappedException) {
     ...
     *            the message key of this exception
     */
    public MovieFinderException(final MessageSource messageSource, final String messageKey, final Object[] messageParameters) {
     ...
     *            the message key of this exception
     */
    public MovieFinderException(final MessageSource messageSource, final String messageKey) {
     ...
     *            the exception that is wrapped in this exception
     */
    public MovieFinderException(final MessageSource messageSource, final String messageKey, final Throwable wrappedException) {
