...
import sample.core.moviefinder.service.MovieFinder;

/**
 * This MovieFinderController class is a Controller class to provide movie list functionality.
 * 
 * @author Sooyeon Park
 */
...
public class MovieFinderController {
    ...
    public String list(@RequestParam(value = "pageIndex", defaultValue = "1") int pageIndex, Movie movie, BindingResult result, Model model) throws Exception {
        ...
        return "/sample/moviefinder/movie/list";
    }
}
