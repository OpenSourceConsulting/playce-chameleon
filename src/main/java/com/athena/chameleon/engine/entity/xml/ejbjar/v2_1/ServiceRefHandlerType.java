...
public class ServiceRefHandlerType {
    ...
    protected com.athena.chameleon.engine.entity.xml.ejbjar.v2_1.String handlerName;
    ...
    protected List<com.athena.chameleon.engine.entity.xml.ejbjar.v2_1.String> soapRole;
    @XmlElement(name = "port-name")
    protected List<com.athena.chameleon.engine.entity.xml.ejbjar.v2_1.String> portName;
     ...
     * @return
     *     possible object is
     *     {@link com.athena.chameleon.engine.entity.xml.ejbjar.v2_1.String }
     *     
     */
    public com.athena.chameleon.engine.entity.xml.ejbjar.v2_1.String getHandlerName() {
        return handlerName;
    }
     ...
     *     
     */
    public void setHandlerName(com.athena.chameleon.engine.entity.xml.ejbjar.v2_1.String value) {
     ...
     * 
     */
    public List<com.athena.chameleon.engine.entity.xml.ejbjar.v2_1.String> getSoapRole() {
        if (soapRole == null) {
            soapRole = new ArrayList<com.athena.chameleon.engine.entity.xml.ejbjar.v2_1.String>();
        }
     ...
     * 
     */
    public List<com.athena.chameleon.engine.entity.xml.ejbjar.v2_1.String> getPortName() {
        if (portName == null) {
            portName = new ArrayList<com.athena.chameleon.engine.entity.xml.ejbjar.v2_1.String>();
        }
