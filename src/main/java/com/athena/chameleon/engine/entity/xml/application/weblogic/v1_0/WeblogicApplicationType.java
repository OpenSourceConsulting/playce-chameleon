 ...
 *       &lt;sequence>
 *         &lt;element name="ejb" type="{http://www.bea.com/ns/weblogic/weblogic-application}ejbType" minOccurs="0"/>
 *         &lt;element name="xml" type="{http://www.bea.com/ns/weblogic/weblogic-application}xmlType" minOccurs="0"/>
 *         &lt;element name="jdbc-connection-pool" type="{http://www.bea.com/ns/weblogic/weblogic-application}jdbc-connection-poolType" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="security" type="{http://www.bea.com/ns/weblogic/weblogic-application}securityType" minOccurs="0"/>
 *         &lt;element name="application-param" type="{http://www.bea.com/ns/weblogic/weblogic-application}application-paramType" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="classloader-structure" type="{http://www.bea.com/ns/weblogic/weblogic-application}classloader-structureType" minOccurs="0"/>
 *         &lt;element name="listener" type="{http://www.bea.com/ns/weblogic/weblogic-application}listenerType" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="singleton-service" type="{http://www.bea.com/ns/weblogic/weblogic-application}singletonServiceType" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="startup" type="{http://www.bea.com/ns/weblogic/weblogic-application}startupType" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="shutdown" type="{http://www.bea.com/ns/weblogic/weblogic-application}shutdownType" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="module" type="{http://www.bea.com/ns/weblogic/weblogic-application}weblogic-moduleType" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="library-ref" type="{http://www.bea.com/ns/weblogic/weblogic-application}library-refType" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="fair-share-request" type="{http://www.bea.com/ns/weblogic/weblogic-application}fair-share-request-classType" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="response-time-request" type="{http://www.bea.com/ns/weblogic/weblogic-application}response-time-request-classType" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="context-request" type="{http://www.bea.com/ns/weblogic/weblogic-application}context-request-classType" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="max-threads-constraint" type="{http://www.bea.com/ns/weblogic/weblogic-application}max-threads-constraintType" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="min-threads-constraint" type="{http://www.bea.com/ns/weblogic/weblogic-application}min-threads-constraintType" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="capacity" type="{http://www.bea.com/ns/weblogic/weblogic-application}capacityType" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="work-manager" type="{http://www.bea.com/ns/weblogic/weblogic-application}work-managerType" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="component-factory-class-name" type="{http://java.sun.com/xml/ns/javaee}xsdStringType" minOccurs="0"/>
 *         &lt;element name="application-admin-mode-trigger" type="{http://www.bea.com/ns/weblogic/weblogic-application}application-admin-mode-triggerType" minOccurs="0"/>
 *         &lt;element name="session-descriptor" type="{http://www.bea.com/ns/weblogic/weblogic-application}session-descriptorType" minOccurs="0"/>
 *         &lt;element name="library-context-root-override" type="{http://www.bea.com/ns/weblogic/weblogic-application}library-context-root-overrideType" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="prefer-application-packages" type="{http://www.bea.com/ns/weblogic/weblogic-application}prefer-application-packagesType" minOccurs="0"/>
 *         &lt;element name="fast-swap" type="{http://www.bea.com/ns/weblogic/weblogic-application}fast-swapType" minOccurs="0"/>
 *       &lt;/sequence>
...
@javax.xml.bind.annotation.XmlType(name = "weblogic-applicationType", namespace = "http://www.bea.com/ns/weblogic/weblogic-application", propOrder = {
    "ejb",
    "xml",
    "jdbcConnectionPool",
    "security",
...
public class WeblogicApplicationType {
    ...
    @XmlElement(namespace = "http://www.bea.com/ns/weblogic/weblogic-application")
    protected com.athena.chameleon.engine.entity.xml.application.weblogic.v1_0.XmlType xml;
    @XmlElement(name = "jdbc-connection-pool", namespace = "http://www.bea.com/ns/weblogic/weblogic-application", required = true)
    protected List<JdbcConnectionPoolType> jdbcConnectionPool;
    @XmlElement(namespace = "http://www.bea.com/ns/weblogic/weblogic-application")
    protected SecurityType security;
    @XmlElement(name = "application-param", namespace = "http://www.bea.com/ns/weblogic/weblogic-application", required = true)
    protected List<ApplicationParamType> applicationParam;
    @XmlElement(name = "classloader-structure", namespace = "http://www.bea.com/ns/weblogic/weblogic-application")
    ...
    @XmlElement(name = "singleton-service", namespace = "http://www.bea.com/ns/weblogic/weblogic-application", required = true)
    ...
    @XmlElement(name = "library-ref", namespace = "http://www.bea.com/ns/weblogic/weblogic-application", required = true)
    protected List<LibraryRefType> libraryRef;
    @XmlElement(name = "fair-share-request", namespace = "http://www.bea.com/ns/weblogic/weblogic-application", required = true)
    protected List<FairShareRequestClassType> fairShareRequest;
    @XmlElement(name = "response-time-request", namespace = "http://www.bea.com/ns/weblogic/weblogic-application", required = true)
    protected List<ResponseTimeRequestClassType> responseTimeRequest;
    @XmlElement(name = "context-request", namespace = "http://www.bea.com/ns/weblogic/weblogic-application", required = true)
    protected List<ContextRequestClassType> contextRequest;
    @XmlElement(name = "max-threads-constraint", namespace = "http://www.bea.com/ns/weblogic/weblogic-application", required = true)
    protected List<MaxThreadsConstraintType> maxThreadsConstraint;
    @XmlElement(name = "min-threads-constraint", namespace = "http://www.bea.com/ns/weblogic/weblogic-application", required = true)
    protected List<MinThreadsConstraintType> minThreadsConstraint;
    @XmlElement(namespace = "http://www.bea.com/ns/weblogic/weblogic-application", required = true)
    protected List<CapacityType> capacity;
    @XmlElement(name = "work-manager", namespace = "http://www.bea.com/ns/weblogic/weblogic-application", required = true)
    protected List<WorkManagerType> workManager;
    @XmlElement(name = "component-factory-class-name", namespace = "http://www.bea.com/ns/weblogic/weblogic-application")
    protected XsdStringType componentFactoryClassName;
    @XmlElement(name = "application-admin-mode-trigger", namespace = "http://www.bea.com/ns/weblogic/weblogic-application")
    protected ApplicationAdminModeTriggerType applicationAdminModeTrigger;
    @XmlElement(name = "session-descriptor", namespace = "http://www.bea.com/ns/weblogic/weblogic-application")
    protected SessionDescriptorType sessionDescriptor;
    @XmlElement(name = "library-context-root-override", namespace = "http://www.bea.com/ns/weblogic/weblogic-application", required = true)
    protected List<LibraryContextRootOverrideType> libraryContextRootOverride;
    @XmlElement(name = "prefer-application-packages", namespace = "http://www.bea.com/ns/weblogic/weblogic-application")
    protected PreferApplicationPackagesType preferApplicationPackages;
    @XmlElement(name = "fast-swap", namespace = "http://www.bea.com/ns/weblogic/weblogic-application")
    protected FastSwapType fastSwap;
    @XmlAttribute
     ...
     * @return
     *     possible object is
     *     {@link com.athena.chameleon.engine.entity.xml.application.weblogic.v1_0.XmlType }
     *     
     */
    public com.athena.chameleon.engine.entity.xml.application.weblogic.v1_0.XmlType getXml() {
        return xml;
    }
     ...
     *     
     */
    public void setXml(com.athena.chameleon.engine.entity.xml.application.weblogic.v1_0.XmlType value) {
        this.xml = value;
    }
    ...
    /**
     * Gets the value of the componentFactoryClassName property.
     * 
     * @return
     *     possible object is
     *     {@link XsdStringType }
    ...
    /**
     * Sets the value of the componentFactoryClassName property.
     * 
     * @param value
     *     allowed object is
     *     {@link XsdStringType }
     *     
     */
    public void setComponentFactoryClassName(XsdStringType value) {
        this.componentFactoryClassName = value;
    }
    ...
    /**
     * Gets the value of the fastSwap property.
     * 
     * @return
     *     possible object is
     *     {@link FastSwapType }
    ...
    /**
     * Sets the value of the fastSwap property.
     * 
     * @param value
     *     allowed object is
     *     {@link FastSwapType }
