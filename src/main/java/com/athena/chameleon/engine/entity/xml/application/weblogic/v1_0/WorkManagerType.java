 ...
 *       &lt;sequence>
 *         &lt;element name="name" type="{http://www.bea.com/ns/weblogic/weblogic-application}dispatch-policyType"/>
 *         &lt;choice minOccurs="0">
 *           &lt;element name="response-time-request-class" type="{http://www.bea.com/ns/weblogic/weblogic-application}response-time-request-classType"/>
 *           &lt;element name="fair-share-request-class" type="{http://www.bea.com/ns/weblogic/weblogic-application}fair-share-request-classType"/>
 *           &lt;element name="context-request-class" type="{http://www.bea.com/ns/weblogic/weblogic-application}context-request-classType"/>
 *           &lt;element name="request-class-name" type="{http://java.sun.com/xml/ns/javaee}xsdStringType"/>
 *         &lt;/choice>
 *         &lt;choice minOccurs="0">
 *           &lt;element name="min-threads-constraint" type="{http://www.bea.com/ns/weblogic/weblogic-application}min-threads-constraintType"/>
 *           &lt;element name="min-threads-constraint-name" type="{http://java.sun.com/xml/ns/javaee}xsdStringType"/>
 *         &lt;/choice>
 *         &lt;choice minOccurs="0">
 *           &lt;element name="max-threads-constraint" type="{http://www.bea.com/ns/weblogic/weblogic-application}max-threads-constraintType"/>
 *           &lt;element name="max-threads-constraint-name" type="{http://java.sun.com/xml/ns/javaee}xsdStringType"/>
 *         &lt;/choice>
 *         &lt;choice minOccurs="0">
 *           &lt;element name="capacity" type="{http://www.bea.com/ns/weblogic/weblogic-application}capacityType"/>
 *           &lt;element name="capacity-name" type="{http://java.sun.com/xml/ns/javaee}xsdStringType"/>
 *         &lt;/choice>
 *         &lt;choice minOccurs="0">
 *           &lt;element name="work-manager-shutdown-trigger" type="{http://www.bea.com/ns/weblogic/weblogic-application}work-manager-shutdown-triggerType"/>
 *           &lt;element name="ignore-stuck-threads" type="{http://java.sun.com/xml/ns/javaee}xsdBooleanType"/>
 *         &lt;/choice>
 *       &lt;/sequence>
...
@XmlType(name = "work-managerType", namespace = "http://www.bea.com/ns/weblogic/weblogic-application", propOrder = {
    "name",
...
public class WorkManagerType {
    ...
    @XmlElement(name = "response-time-request-class", namespace = "http://www.bea.com/ns/weblogic/weblogic-application")
    protected ResponseTimeRequestClassType responseTimeRequestClass;
    @XmlElement(name = "fair-share-request-class", namespace = "http://www.bea.com/ns/weblogic/weblogic-application")
    protected FairShareRequestClassType fairShareRequestClass;
    @XmlElement(name = "context-request-class", namespace = "http://www.bea.com/ns/weblogic/weblogic-application")
    protected ContextRequestClassType contextRequestClass;
    @XmlElement(name = "request-class-name", namespace = "http://www.bea.com/ns/weblogic/weblogic-application")
    protected XsdStringType requestClassName;
    @XmlElement(name = "min-threads-constraint", namespace = "http://www.bea.com/ns/weblogic/weblogic-application")
    protected MinThreadsConstraintType minThreadsConstraint;
    @XmlElement(name = "min-threads-constraint-name", namespace = "http://www.bea.com/ns/weblogic/weblogic-application")
    protected XsdStringType minThreadsConstraintName;
    @XmlElement(name = "max-threads-constraint", namespace = "http://www.bea.com/ns/weblogic/weblogic-application")
    protected MaxThreadsConstraintType maxThreadsConstraint;
    @XmlElement(name = "max-threads-constraint-name", namespace = "http://www.bea.com/ns/weblogic/weblogic-application")
    ...
    @XmlElement(name = "capacity-name", namespace = "http://www.bea.com/ns/weblogic/weblogic-application")
    protected XsdStringType capacityName;
    @XmlElement(name = "work-manager-shutdown-trigger", namespace = "http://www.bea.com/ns/weblogic/weblogic-application")
    protected WorkManagerShutdownTriggerType workManagerShutdownTrigger;
    @XmlElement(name = "ignore-stuck-threads", namespace = "http://www.bea.com/ns/weblogic/weblogic-application")
