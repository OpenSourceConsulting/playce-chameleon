...
public class ServiceRefHandlerType {
    ...
    protected com.athena.chameleon.engine.entity.xml.webapp.String handlerName;
    ...
    protected List<com.athena.chameleon.engine.entity.xml.webapp.String> soapRole;
    @XmlElement(name = "port-name")
    protected List<com.athena.chameleon.engine.entity.xml.webapp.String> portName;
     ...
     *     
     */
    public com.athena.chameleon.engine.entity.xml.webapp.String getHandlerName() {
        return handlerName;
    }
     ...
     *     
     */
    public void setHandlerName(com.athena.chameleon.engine.entity.xml.webapp.String value) {
     ...
     * 
     */
    public List<com.athena.chameleon.engine.entity.xml.webapp.String> getSoapRole() {
        if (soapRole == null) {
            soapRole = new ArrayList<com.athena.chameleon.engine.entity.xml.webapp.String>();
        }
     ...
     * 
     */
    public List<com.athena.chameleon.engine.entity.xml.webapp.String> getPortName() {
        if (portName == null) {
            portName = new ArrayList<com.athena.chameleon.engine.entity.xml.webapp.String>();
        }
