...
public class ServiceRefHandlerType {
    ...
    protected com.athena.chameleon.engine.entity.xml.application.v1_4.String handlerName;
    ...
    protected List<com.athena.chameleon.engine.entity.xml.application.v1_4.String> soapRole;
    @XmlElement(name = "port-name")
    protected List<com.athena.chameleon.engine.entity.xml.application.v1_4.String> portName;
     ...
     * @return
     *     possible object is
     *     {@link com.athena.chameleon.engine.entity.xml.application.v1_4.String }
     *     
     */
    public com.athena.chameleon.engine.entity.xml.application.v1_4.String getHandlerName() {
        return handlerName;
    }
     ...
     *     
     */
    public void setHandlerName(com.athena.chameleon.engine.entity.xml.application.v1_4.String value) {
     ...
     * 
     */
    public List<com.athena.chameleon.engine.entity.xml.application.v1_4.String> getSoapRole() {
        if (soapRole == null) {
            soapRole = new ArrayList<com.athena.chameleon.engine.entity.xml.application.v1_4.String>();
        }
     ...
     * 
     */
    public List<com.athena.chameleon.engine.entity.xml.application.v1_4.String> getPortName() {
        if (portName == null) {
            portName = new ArrayList<com.athena.chameleon.engine.entity.xml.application.v1_4.String>();
        }
