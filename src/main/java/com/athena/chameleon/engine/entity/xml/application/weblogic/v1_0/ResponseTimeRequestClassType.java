 ...
 *         &lt;element name="goal-ms" type="{http://java.sun.com/xml/ns/javaee}xsdIntegerType"/>
 *       &lt;/sequence>
...
@XmlType(name = "response-time-request-classType", namespace = "http://www.bea.com/ns/weblogic/weblogic-application", propOrder = {
    "name",
    "goalMs"
})
public class ResponseTimeRequestClassType {
    ...
    @XmlElement(name = "goal-ms", namespace = "http://www.bea.com/ns/weblogic/weblogic-application", required = true)
