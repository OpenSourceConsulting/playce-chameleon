...
@XmlType(name = "shutdownType", propOrder = {
    "shutdownClass",
    "shutdownUri"
})
public class ShutdownType {

    @XmlElement(name = "shutdown-class", namespace = "http://www.bea.com/ns/weblogic/90", required = true)
    protected java.lang.String shutdownClass;
    @XmlElement(name = "shutdown-uri", namespace = "http://www.bea.com/ns/weblogic/90")
