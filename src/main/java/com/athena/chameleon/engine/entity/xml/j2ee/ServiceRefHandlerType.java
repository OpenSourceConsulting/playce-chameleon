...
public class ServiceRefHandlerType {
    ...
    protected com.athena.chameleon.engine.entity.xml.j2ee.String handlerName;
    ...
    protected List<com.athena.chameleon.engine.entity.xml.j2ee.String> soapRole;
    @XmlElement(name = "port-name")
    protected List<com.athena.chameleon.engine.entity.xml.j2ee.String> portName;
     ...
     *     
     */
    public com.athena.chameleon.engine.entity.xml.j2ee.String getHandlerName() {
        return handlerName;
    }
     ...
     *     
     */
    public void setHandlerName(com.athena.chameleon.engine.entity.xml.j2ee.String value) {
     ...
     * 
     */
    public List<com.athena.chameleon.engine.entity.xml.j2ee.String> getSoapRole() {
        if (soapRole == null) {
            soapRole = new ArrayList<com.athena.chameleon.engine.entity.xml.j2ee.String>();
        }
     ...
     * 
     */
    public List<com.athena.chameleon.engine.entity.xml.j2ee.String> getPortName() {
        if (portName == null) {
            portName = new ArrayList<com.athena.chameleon.engine.entity.xml.j2ee.String>();
        }
