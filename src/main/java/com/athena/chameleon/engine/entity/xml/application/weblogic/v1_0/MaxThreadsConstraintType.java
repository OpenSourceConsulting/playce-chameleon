 ...
 *           &lt;element name="pool-name" type="{http://java.sun.com/xml/ns/javaee}xsdStringType"/>
 *         &lt;/choice>
 *       &lt;/sequence>
...
@XmlType(name = "max-threads-constraintType", namespace = "http://www.bea.com/ns/weblogic/weblogic-application", propOrder = {
    "name",
    "count",
    "poolName"
})
public class MaxThreadsConstraintType {
    ...
    @XmlElement(name = "pool-name", namespace = "http://www.bea.com/ns/weblogic/weblogic-application")
