...
public class FindMethodType {
    ...
    @XmlElement(name = "query-method", namespace = "http://www.tmaxsoft.com/xml/ns/jeus", required = true)
    protected MethodParamType queryMethod;
    @XmlElement(namespace = "http://www.tmaxsoft.com/xml/ns/jeus")
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    protected String sql;
    @XmlElement(name = "include-updates", namespace = "http://www.tmaxsoft.com/xml/ns/jeus")
