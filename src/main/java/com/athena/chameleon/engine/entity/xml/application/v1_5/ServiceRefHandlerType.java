...
public class ServiceRefHandlerType {
    ...
    protected com.athena.chameleon.engine.entity.xml.application.v1_5.String handlerName;
    ...
    protected List<com.athena.chameleon.engine.entity.xml.application.v1_5.String> soapRole;
    @XmlElement(name = "port-name", namespace = "http://java.sun.com/xml/ns/javaee", required = true)
    protected List<com.athena.chameleon.engine.entity.xml.application.v1_5.String> portName;
    @XmlAttribute
     ...
     *     
     */
    public com.athena.chameleon.engine.entity.xml.application.v1_5.String getHandlerName() {
        return handlerName;
    }
     ...
     *     
     */
    public void setHandlerName(com.athena.chameleon.engine.entity.xml.application.v1_5.String value) {
     ...
     * 
     */
    public List<com.athena.chameleon.engine.entity.xml.application.v1_5.String> getSoapRole() {
        if (soapRole == null) {
            soapRole = new ArrayList<com.athena.chameleon.engine.entity.xml.application.v1_5.String>();
        }
     ...
     * 
     */
    public List<com.athena.chameleon.engine.entity.xml.application.v1_5.String> getPortName() {
        if (portName == null) {
            portName = new ArrayList<com.athena.chameleon.engine.entity.xml.application.v1_5.String>();
        }
