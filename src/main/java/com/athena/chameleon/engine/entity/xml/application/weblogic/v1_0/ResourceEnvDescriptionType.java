...
@XmlType(name = "resource-env-descriptionType", namespace = "http://www.bea.com/ns/weblogic/weblogic-application", propOrder = {
    "resourceEnvRefName",
    "jndiName",
    "resourceLink"
})
public class ResourceEnvDescriptionType {
    ...
    @XmlElement(name = "resource-env-ref-name", namespace = "http://www.bea.com/ns/weblogic/weblogic-application", required = true)
