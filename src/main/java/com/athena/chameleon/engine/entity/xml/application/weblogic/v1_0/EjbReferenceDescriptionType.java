 ...
 *         &lt;element name="jndi-name" type="{http://java.sun.com/xml/ns/javaee}jndi-nameType"/>
 *       &lt;/sequence>
...
@XmlType(name = "ejb-reference-descriptionType", namespace = "http://www.bea.com/ns/weblogic/weblogic-application", propOrder = {
    "ejbRefName",
    "jndiName"
})
public class EjbReferenceDescriptionType {

    @XmlElement(name = "ejb-ref-name", namespace = "http://www.bea.com/ns/weblogic/weblogic-application", required = true)
    protected EjbRefNameType ejbRefName;
    @XmlElement(name = "jndi-name", namespace = "http://www.bea.com/ns/weblogic/weblogic-application", required = true)
