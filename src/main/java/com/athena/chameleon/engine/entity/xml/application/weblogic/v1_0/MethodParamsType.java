...
@XmlType(name = "method-paramsType", namespace = "http://www.bea.com/ns/weblogic/weblogic-application", propOrder = {
    "methodParam"
})
public class MethodParamsType {

    @XmlElement(name = "method-param", namespace = "http://www.bea.com/ns/weblogic/weblogic-application", required = true)
