 ...
 *         &lt;element name="connection-params" type="{http://www.bea.com/ns/weblogic/90}connection-paramsType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "connection-propertiesType", propOrder = {
    "userName",
    "password",
    "url",
    "driverClassName",
...
public class ConnectionPropertiesType {
    ...
    @XmlElement(name = "driver-class-name", namespace = "http://www.bea.com/ns/weblogic/90")
    protected java.lang.String driverClassName;
    @XmlElement(name = "connection-params", namespace = "http://www.bea.com/ns/weblogic/90", required = true)
