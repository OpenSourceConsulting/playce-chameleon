 ...
 *       &lt;sequence>
 *         &lt;element name="message-destination-name" type="{http://www.bea.com/ns/weblogic/weblogic-application}message-destination-nameType"/>
 *         &lt;choice>
 *           &lt;sequence>
 *             &lt;element name="destination-jndi-name" type="{http://www.bea.com/ns/weblogic/weblogic-application}destination-jndi-nameType"/>
 *             &lt;element name="initial-context-factory" type="{http://www.bea.com/ns/weblogic/weblogic-application}initial-context-factoryType" minOccurs="0"/>
 *             &lt;element name="provider-url" type="{http://www.bea.com/ns/weblogic/weblogic-application}provider-urlType" minOccurs="0"/>
 *           &lt;/sequence>
 *           &lt;element name="destination-resource-link" type="{http://java.sun.com/xml/ns/javaee}string"/>
 *         &lt;/choice>
 *       &lt;/sequence>
...
@XmlType(name = "message-destination-descriptorType", namespace = "http://www.bea.com/ns/weblogic/weblogic-application", propOrder = {
...
public class MessageDestinationDescriptorType {
    ...
    @XmlElement(name = "message-destination-name", namespace = "http://www.bea.com/ns/weblogic/weblogic-application", required = true)
    protected MessageDestinationNameType messageDestinationName;
    @XmlElement(name = "destination-jndi-name", namespace = "http://www.bea.com/ns/weblogic/weblogic-application")
    protected DestinationJndiNameType destinationJndiName;
    @XmlElement(name = "initial-context-factory", namespace = "http://www.bea.com/ns/weblogic/weblogic-application")
    protected InitialContextFactoryType initialContextFactory;
    @XmlElement(name = "provider-url", namespace = "http://www.bea.com/ns/weblogic/weblogic-application")
    protected ProviderUrlType providerUrl;
    @XmlElement(name = "destination-resource-link", namespace = "http://www.bea.com/ns/weblogic/weblogic-application")
    protected com.athena.chameleon.engine.entity.xml.application.weblogic.v1_0.String destinationResourceLink;
    @XmlAttribute
     ...
     *     
     */
    public com.athena.chameleon.engine.entity.xml.application.weblogic.v1_0.String getDestinationResourceLink() {
     ...
     *     
     */
    public void setDestinationResourceLink(com.athena.chameleon.engine.entity.xml.application.weblogic.v1_0.String value) {
