 ...
 *         &lt;element name="check-query-timeout" type="{http://www.tmaxsoft.com/xml/ns/jeus}nonNegativeLongType" minOccurs="0"/>
 *         &lt;element name="non-validation-interval" type="{http://www.tmaxsoft.com/xml/ns/jeus}nonNegativeLongType" minOccurs="0"/>
 *         &lt;element name="check-query-period" type="{http://www.tmaxsoft.com/xml/ns/jeus}nonNegativeLongType" minOccurs="0"/>
 *         &lt;element name="check-query-retrial-count" type="{http://www.tmaxsoft.com/xml/ns/jeus}nonNegativeIntType" minOccurs="0"/>
 *         &lt;element name="check-query-class" type="{http://www.w3.org/2001/XMLSchema}token" minOccurs="0"/>
 *         &lt;element name="destroy-policy-on-check-query" type="{http://www.tmaxsoft.com/xml/ns/jeus}destroy-policy-on-check-queryType" minOccurs="0"/>
 ...
 *         &lt;element name="connection-trace" type="{http://www.tmaxsoft.com/xml/ns/jeus}jdbc-connection-traceType" minOccurs="0"/>
 *         &lt;element name="use-sql-trace" type="{http://www.w3.org/2001/XMLSchema}boolean" minOccurs="0"/>
 *         &lt;element name="keep-connection-handle-open" type="{http://www.w3.org/2001/XMLSchema}boolean" minOccurs="0"/>
 *         &lt;element name="init-sql" type="{http://www.w3.org/2001/XMLSchema}token" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "database-connection-poolType", propOrder = {
    ...
    "checkQuery",
    "checkQueryTimeout",
    "nonValidationInterval",
    "checkQueryPeriod",
    "checkQueryRetrialCount",
    "checkQueryClass",
    "destroyPolicyOnCheckQuery",
    "stmtCachingSize",
    "stmtFetchSize",
    "connectionTrace",
    "useSqlTrace",
...
public class DatabaseConnectionPoolType {
    ...
    @XmlElement(name = "check-query-timeout", namespace = "http://www.tmaxsoft.com/xml/ns/jeus", defaultValue = "0")
    protected Long checkQueryTimeout;
    @XmlElement(name = "non-validation-interval", namespace = "http://www.tmaxsoft.com/xml/ns/jeus", defaultValue = "0")
    ...
    @XmlElement(name = "check-query-retrial-count", namespace = "http://www.tmaxsoft.com/xml/ns/jeus", defaultValue = "0")
    ...
    @XmlElement(name = "destroy-policy-on-check-query", namespace = "http://www.tmaxsoft.com/xml/ns/jeus", defaultValue = "FailedConnectionOnly")
    ...
    @XmlElement(name = "connection-trace", namespace = "http://www.tmaxsoft.com/xml/ns/jeus")
    protected JdbcConnectionTraceType connectionTrace;
    @XmlElement(name = "use-sql-trace", namespace = "http://www.tmaxsoft.com/xml/ns/jeus", defaultValue = "false")
    ...
    @XmlElement(name = "init-sql", namespace = "http://www.tmaxsoft.com/xml/ns/jeus")
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    ...
    /**
     * Gets the value of the checkQueryTimeout property.
     * 
     * @return
     *     possible object is
     *     {@link Long }
    ...
    public Long getCheckQueryTimeout() {
        return checkQueryTimeout;
    }

    /**
     * Sets the value of the checkQueryTimeout property.
     * 
     * @param value
     *     allowed object is
     *     {@link Long }
     *     
     */
    public void setCheckQueryTimeout(Long value) {
        this.checkQueryTimeout = value;
    }

    /**
     * Gets the value of the nonValidationInterval property.
     * 
     * @return
     *     possible object is
     *     {@link Long }
    ...
    public Long getNonValidationInterval() {
        return nonValidationInterval;
    }

    /**
     * Sets the value of the nonValidationInterval property.
     * 
     * @param value
     *     allowed object is
     *     {@link Long }
     *     
     */
    public void setNonValidationInterval(Long value) {
        this.nonValidationInterval = value;
    }
    ...
    /**
     * Gets the value of the checkQueryRetrialCount property.
     * 
     * @return
     *     possible object is
     *     {@link Integer }
    ...
    public Integer getCheckQueryRetrialCount() {
        return checkQueryRetrialCount;
    }

    /**
     * Sets the value of the checkQueryRetrialCount property.
     * 
     * @param value
     *     allowed object is
     *     {@link Integer }
     *     
     */
    public void setCheckQueryRetrialCount(Integer value) {
        this.checkQueryRetrialCount = value;
    }
    ...
    /**
     * Gets the value of the destroyPolicyOnCheckQuery property.
     * 
     * @return
     *     possible object is
     *     {@link DestroyPolicyOnCheckQueryType }
     *     
     */
    public DestroyPolicyOnCheckQueryType getDestroyPolicyOnCheckQuery() {
        return destroyPolicyOnCheckQuery;
    }

    /**
     * Sets the value of the destroyPolicyOnCheckQuery property.
     * 
     * @param value
     *     allowed object is
     *     {@link DestroyPolicyOnCheckQueryType }
     *     
     */
    public void setDestroyPolicyOnCheckQuery(DestroyPolicyOnCheckQueryType value) {
        this.destroyPolicyOnCheckQuery = value;
    }
     ...
     *     
     */
    public void setConnectionTrace(JdbcConnectionTraceType value) {
     ...
     *     
     */
    public void setUseSqlTrace(Boolean value) {
