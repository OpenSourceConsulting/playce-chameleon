 ...
 *       &lt;sequence>
 *         &lt;element name="size-params" type="{http://www.bea.com/ns/weblogic/90}size-paramsType" minOccurs="0"/>
 *         &lt;element name="xa-params" type="{http://www.bea.com/ns/weblogic/90}xa-paramsType" minOccurs="0"/>
 *         &lt;element name="login-delay-seconds" type="{http://www.w3.org/2001/XMLSchema}int" minOccurs="0"/>
 *         &lt;element name="leak-profiling-enabled" type="{http://www.bea.com/ns/weblogic/90}true-falseType" minOccurs="0"/>
 *         &lt;element name="connection-check-params" type="{http://www.bea.com/ns/weblogic/90}connection-check-paramsType" minOccurs="0"/>
 *         &lt;element name="jdbcxa-debug-level" type="{http://www.w3.org/2001/XMLSchema}int" minOccurs="0"/>
 *         &lt;element name="remove-infected-connections-enabled" type="{http://www.bea.com/ns/weblogic/90}true-falseType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "application-pool-paramsType", propOrder = {
    "sizeParams",
    "xaParams",
    "loginDelaySeconds",
...
public class ApplicationPoolParamsType {
    ...
    @XmlElement(name = "size-params", namespace = "http://www.bea.com/ns/weblogic/90")
    protected SizeParamsType sizeParams;
    @XmlElement(name = "xa-params", namespace = "http://www.bea.com/ns/weblogic/90")
    protected XaParamsType xaParams;
    @XmlElement(name = "login-delay-seconds", namespace = "http://www.bea.com/ns/weblogic/90")
    protected Integer loginDelaySeconds;
    @XmlElement(name = "leak-profiling-enabled", namespace = "http://www.bea.com/ns/weblogic/90")
    protected TrueFalseType leakProfilingEnabled;
    @XmlElement(name = "connection-check-params", namespace = "http://www.bea.com/ns/weblogic/90")
    protected ConnectionCheckParamsType connectionCheckParams;
    @XmlElement(name = "jdbcxa-debug-level", namespace = "http://www.bea.com/ns/weblogic/90")
    protected Integer jdbcxaDebugLevel;
    @XmlElement(name = "remove-infected-connections-enabled", namespace = "http://www.bea.com/ns/weblogic/90")
