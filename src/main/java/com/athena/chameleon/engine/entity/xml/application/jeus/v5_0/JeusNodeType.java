 ...
 *         &lt;element name="remote-webtob-list" type="{http://www.tmaxsoft.com/xml/ns/jeus}remote-webtob-listType" minOccurs="0"/>
 ...
 *         &lt;element name="enable-jnlp" type="{http://www.w3.org/2001/XMLSchema}boolean" minOccurs="0"/>
...
public class JeusNodeType {
    ...
    @XmlElement(name = "remote-webtob-list", namespace = "http://www.tmaxsoft.com/xml/ns/jeus")
    protected RemoteWebtobListType remoteWebtobList;
    @XmlElement(name = "class-ftp", namespace = "http://www.tmaxsoft.com/xml/ns/jeus")
    protected Boolean classFtp;
    @XmlElement(name = "sequential-start", namespace = "http://www.tmaxsoft.com/xml/ns/jeus")
    protected Boolean sequentialStart;
    @XmlElement(namespace = "http://www.tmaxsoft.com/xml/ns/jeus")
    protected SchedulerType scheduler;
    @XmlElement(name = "enable-jnlp", namespace = "http://www.tmaxsoft.com/xml/ns/jeus")
    protected Boolean enableJnlp;
    ...
    /**
     * Gets the value of the remoteWebtobList property.
     * 
     * @return
     *     possible object is
     *     {@link RemoteWebtobListType }
     *     
     */
    public RemoteWebtobListType getRemoteWebtobList() {
        return remoteWebtobList;
    }

    /**
     * Sets the value of the remoteWebtobList property.
     * 
     * @param value
     *     allowed object is
     *     {@link RemoteWebtobListType }
     *     
     */
    public void setRemoteWebtobList(RemoteWebtobListType value) {
        this.remoteWebtobList = value;
    }
    ...
    /**
     * Gets the value of the enableJnlp property.
     * 
     * @return
     *     possible object is
     *     {@link Boolean }
    ...
    /**
     * Sets the value of the enableJnlp property.
     * 
     * @param value
     *     allowed object is
     *     {@link Boolean }
     *     
     */
    public void setEnableJnlp(Boolean value) {
        this.enableJnlp = value;
    }
