...
public class Shutdown {
    ...
    @XmlElement(name = "shutdown-class", required = true)
    protected String shutdownClass;
    @XmlElement(name = "shutdown-uri")
    protected String shutdownUri;

    /**
     * shutdownClass 속성의 값을 가져옵니다.
     * 
     * @return
     *     possible object is
     *     {@link String }
