 ...
 *         &lt;element name="fair-share" type="{http://java.sun.com/xml/ns/javaee}xsdIntegerType"/>
 *       &lt;/sequence>
...
@XmlType(name = "fair-share-request-classType", namespace = "http://www.bea.com/ns/weblogic/weblogic-application", propOrder = {
    "name",
    "fairShare"
})
public class FairShareRequestClassType {
    ...
    @XmlElement(name = "fair-share", namespace = "http://www.bea.com/ns/weblogic/weblogic-application", required = true)
