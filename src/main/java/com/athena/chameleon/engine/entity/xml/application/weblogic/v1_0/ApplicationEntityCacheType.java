 ...
 *           &lt;element name="max-cache-size" type="{http://www.bea.com/ns/weblogic/weblogic-application}max-cache-sizeType"/>
 *         &lt;/choice>
...
@XmlType(name = "application-entity-cacheType", namespace = "http://www.bea.com/ns/weblogic/weblogic-application", propOrder = {
    "entityCacheName",
    "maxBeansInCache",
    "maxCacheSize",
    "maxQueriesInCache",
...
public class ApplicationEntityCacheType {
    ...
    @XmlElement(name = "entity-cache-name", namespace = "http://www.bea.com/ns/weblogic/weblogic-application", required = true)
    protected java.lang.String entityCacheName;
    @XmlElement(name = "max-beans-in-cache", namespace = "http://www.bea.com/ns/weblogic/weblogic-application")
    protected Integer maxBeansInCache;
    @XmlElement(name = "max-cache-size", namespace = "http://www.bea.com/ns/weblogic/weblogic-application")
    protected MaxCacheSizeType maxCacheSize;
    @XmlElement(name = "max-queries-in-cache", namespace = "http://www.bea.com/ns/weblogic/weblogic-application")
    protected Integer maxQueriesInCache;
    @XmlElement(name = "caching-strategy", namespace = "http://www.bea.com/ns/weblogic/weblogic-application")
