 ...
 *       
 * 
 * <p>service-ref_handlerType complex type에 대한 Java 클래스입니다.
 * 
...
public class ServiceRefHandlerType {
    ...
    protected com.athena.chameleon.engine.entity.xml.webapp.v2_4.String handlerName;
    ...
    protected List<com.athena.chameleon.engine.entity.xml.webapp.v2_4.String> soapRole;
    @XmlElement(name = "port-name")
    protected List<com.athena.chameleon.engine.entity.xml.webapp.v2_4.String> portName;
     ...
     *     
     */
    public com.athena.chameleon.engine.entity.xml.webapp.v2_4.String getHandlerName() {
        return handlerName;
    }

    /**
     * handlerName 속성의 값을 설정합니다.
     * 
     * @param value
     *     allowed object is
     *     {@link com.athena.chameleon.engine.entity.xml.webapp.v2_4.String }
     *     
     */
    public void setHandlerName(com.athena.chameleon.engine.entity.xml.webapp.v2_4.String value) {
     ...
     * 
     */
    public List<com.athena.chameleon.engine.entity.xml.webapp.v2_4.String> getSoapRole() {
        if (soapRole == null) {
            soapRole = new ArrayList<com.athena.chameleon.engine.entity.xml.webapp.v2_4.String>();
        }
     ...
     * 
     */
    public List<com.athena.chameleon.engine.entity.xml.webapp.v2_4.String> getPortName() {
        if (portName == null) {
            portName = new ArrayList<com.athena.chameleon.engine.entity.xml.webapp.v2_4.String>();
        }
