...
@XmlType(name = "application-paramType", propOrder = {
    "description",
    "paramName",
    "paramValue"
})
public class ApplicationParamType {
    ...
    @XmlElement(name = "param-name", namespace = "http://www.bea.com/ns/weblogic/90", required = true)
    protected java.lang.String paramName;
    @XmlElement(name = "param-value", namespace = "http://www.bea.com/ns/weblogic/90", required = true)
